...
~~~~java
.collect(Collector.of($CUSTOM_COLLECTOR$::new, $CUSTOM_COLLECTOR$::accumulate, $CUSTOM_COLLECTOR$::combine, $CUSTOM_COLLECTOR$::finish));

//static class $CUSTOM_COLLECTOR$ {
//
//    void accumulate($TYPE_TO_COLLECT$ other) {
//
//    }
//
//    $CUSTOM_COLLECTOR$ combine($CUSTOM_COLLECTOR$ other) {
//        return this;
//    }
//
//    $TYPE_TO_RETURN$ finish() {
//        return null;
//    }
//
//}

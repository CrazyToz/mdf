...
public class CombatMagique {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        String sequMagique = sc.nextLine();
        String incantation = sc.nextLine();
        System.out.println(Arrays.stream(incantation.split(" ")).map(mot -> mot.contains(sequMagique) ? mot : new StringBuilder(mot).reverse()).collect(Collectors.joining(" ")));

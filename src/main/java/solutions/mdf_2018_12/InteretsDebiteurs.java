...
import static solutions.mdf_2018_12.InteretsDebiteurs.ShortCut.toInt;

public class InteretsDebiteurs {

    public static void main(String[] argv) throws Exception {
        Scanner sc = new Scanner(System.in);
        String line;
        int nbJ = toInt(sc.nextLine());
        double solde = toInt(sc.nextLine());
        int cptMeth1 = 0;
        double intMeth1 = 0;
        int cptMeth2 = 0;
        double intMeth2 = 0;
...
//                cptJ++;
//                switch (cptJ) {
//                    case 1, 2 -> intMeth2 += 20 * -solde / 100;
//                    case 3 -> {
//                        intMeth1 += 10 * -solde / 100;
//                        intMeth2 += 20 * -solde / 100;
//                    }
//                    default -> {
//                        intMeth1 += 10 * -solde / 100;
//                        intMeth2 += 30 * -solde / 100;
//                    }
//
//                }
//            } else {
...
//
        ...
        System.out.println(intMeth2 - intMeth1);
